...
namespace Estoquei.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProduto,PesoProduto,QuantidadeProduto,StatusProduto,TipoProdutoId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProduto,PesoProduto,QuantidadeProduto,StatusProduto,TipoProdutoId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
